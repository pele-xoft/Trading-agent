import type { AnalysisRecord, AnalysisResult, MarketBias, TradeType } from "../types";
...
function ConfidenceBar({ value }: { value: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs font-bold mono" style={{ color, fontFamily: "var(--font-mono, monospace)", minWidth: "2rem", textAlign: "right" }}>
        {value}%
      </span>
    </div>
  );
